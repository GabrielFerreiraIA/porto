    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-porto-primary text-white mb-4 mx-auto">
        ...
        {/* Form card */}
        <div className="bg-white rounded-xl border border-porto-border shadow-xl shadow-porto-primary/8 overflow-hidden">
          {/* Progress bar */}
          {status !== "success" && (
                    ...
                    {step === 1 ? (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 rounded-lg border text-porto-text text-sm outline-none transition-all placeholder:text-porto-muted/60 ${
                              errors.nome
                        ...
                        <button
                          type="button"
                          onClick={goToStep2}
                          className="w-full bg-porto-primary hover:bg-porto-primary-hover text-white font-bold py-4 rounded-lg transition-all duration-200 hover:scale-[1.02] flex items-center justify-center gap-2 mt-2"
                        >
                          Continuar
                      ...
                      >
                        ...
                        <div className="relative z-10">
                          ...
                          <div
                            className={`w-full px-4 py-3 rounded-lg border text-porto-text text-sm cursor-pointer transition-all bg-white flex justify-between items-center ${
                              errors.perfil
                          ...
                          <AnimatePresence>
                            {isPerfilOpen && (
                              <motion.div
                                ...
                                exit={{ opacity: 0, y: -10 }}
                                className="absolute left-0 right-0 z-20 w-full mt-2 bg-white border border-porto-border rounded-lg shadow-lg py-2"
                              >
                                {PERFIS.map((p) => (
                                  <div
                                    key={p.value}
                        ...
                        <div>
                          ...
                          <div className="flex gap-3">
                            {["Sim", "Não"].map((opt) => (
                              <label
                                key={opt}
                                className="flex-1 flex items-center justify-center gap-2 border rounded-lg py-3 cursor-pointer transition-all has-[:checked]:border-porto-primary has-[:checked]:bg-porto-accent-light border-porto-border hover:border-porto-primary/50"
                              >
                                <input
                                  {...register("cnpj")}
                                  type="radio"
                        ...
                        {watchCnpj && (
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              {/* Adultos */}
                              <div className="bg-porto-surface-2 p-4 rounded-lg border border-porto-border flex flex-col items-center">
                        ...
                        <div className="flex gap-3">
                          <button
                            type="button"
                            onClick={goBack}
                            className="flex-none px-5 py-4 rounded-lg border border-porto-border text-porto-text font-medium text-sm hover:bg-porto-surface-2 transition-colors"
                          >
                            Voltar
                          </button>
                          <button
                            ...
                            className="flex-1 bg-porto-primary hover:bg-porto-primary-hover text-white font-bold py-4 rounded-lg transition-all duration-200 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                          >
                            {status === "loading" ? (
                              <>
